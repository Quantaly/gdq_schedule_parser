...
import 'ical_duration_regex.dart';

void main(List<String> args) async {
  var parser = ArgParser()..addOption("x-published-ttl");
  ...
  String ttl = argResults["x-published-ttl"];
  if (ttl != null) {
    if (!(RegExp(durValue).firstMatch(ttl)?.group(0) == ttl)) {
      throw FormatException("Invalid format for RFC2445 duration: $ttl");
    }
    print("X-PUBLISHED-TTL:$ttl");
  }
